...
public final class ExpressionBinder
{
    ...
    private static final ExpressionBind[] binds =
    {
        ...
        new ExpressionBind(INTEGER_TOKEN,
                           new TokenType[]{CARET_TOKEN, CLOSE_PARENTHESIS_TOKEN, EQUALS_EQUALS_TOKEN,
                                           GREATER_EQUALS_TOKEN, GREATER_TOKEN,
                                           LESS_EQUALS_TOKEN, LESS_TOKEN, MINUS_TOKEN,
                                           NOT_EQUALS_TOKEN, PERCENT_TOKEN, PLUS_TOKEN, SLASH_TOKEN,
                                           STAR_TOKEN}),
        ...
        new ExpressionBind(STRING_TOKEN,
                           new TokenType[]{CLOSE_PARENTHESIS_TOKEN, EQUALS_EQUALS_TOKEN, NOT_EQUALS_TOKEN,
                                           PLUS_TOKEN}),
        new ExpressionBind(IDENTIFIER_KEYWORD_TOKEN,
                           new TokenType[]{AND_TOKEN, CARET_TOKEN, CLOSE_PARENTHESIS_TOKEN, EQUALS_EQUALS_TOKEN,
                                           EQUALS_TOKEN, GREATER_EQUALS_TOKEN, GREATER_TOKEN, LESS_EQUALS_TOKEN,
                                           LESS_TOKEN, MINUS_TOKEN, NOT_EQUALS_TOKEN,
                                           OR_TOKEN, PERCENT_TOKEN,
                                           PLUS_TOKEN, SLASH_TOKEN, STAR_TOKEN}),

        // Keyword Tokens
        new ExpressionBind(TRUE_KEYWORD_TOKEN,
                           new TokenType[]{AND_TOKEN, EQUALS_EQUALS_TOKEN, NOT_EQUALS_TOKEN, OR_TOKEN}),
        ...
        new ExpressionBind(CLOSE_PARENTHESIS_TOKEN,
                           new TokenType[]{AND_TOKEN, CARET_TOKEN, CLOSE_PARENTHESIS_TOKEN, EQUALS_EQUALS_TOKEN,
                                           ...
                                           LESS_TOKEN, MINUS_TOKEN, NOT_EQUALS_TOKEN,
                                           OR_TOKEN, PERCENT_TOKEN, PLUS_TOKEN,
