...
## Chapter 1 - Introduction <a name="1" />
...
## Chapter 2 - Background Study <a name="2" />


## Chapter 3 - Requirements <a name="3" />
...
### 4.1 Compiler Design <a name="4.1" />
...
#### 4.1.1 Lexical Analysis <a name="4.1.1" />
...
#### 4.1.2 Syntax Analysis <a name="4.1.2" />
...
#### 4.1.3 Semantic Analysis <a name="4.1.3" />
...
#### 4.1.5 Symbol Table <a name="4.1.5" />
...
#### 4.1.6 Error Handling <a name="4.1.6" />
...
### 4.2 Language Specification <a name="4.2" />
...
#### 4.2.4 Conditionals <a name="4.2.4" />
...
### 4.3 Graphical User Interface <a name="4.3" />
...
#### 4.3.1 Integrated Development Environment <a name="4.3.1" />
...
#### 4.3.2 Read Evaluate Print Loop <a name="4.3.2" />
...
## Chapter 5 - Implementation <a name="5" />
...
### 5.1 Compiler Implementation <a name="5.1" />
...
#### 5.1.1 Lexer <a name="5.1.1" />


#### 5.1.2 Parser <a name="5.1.2" />


#### 5.1.3 Type Checker <a name="5.1.3" />


#### 5.1.4 Evaluator <a name="5.1.4" />


#### 5.1.5 Symbol Table <a name="5.1.5" />


#### 5.1.6 Error Handler <a name="5.1.6" />


### 5.2 Graphical User Interface <a name="5.2" />
...
#### 5.2.1 Visual Layout <a name="5.2.1" />
...
#### 5.2.2 Controllers <a name="5.2.2" />
...
#### 5.2.3 File Manager <a name="5.2.3" />
...
### 6.1.1 User Testing <a name="6.1.1" />
...
#### 6.2.1 Lexer Testing <a name="6.2.1" />
...
#### 6.2.2 Parser Testing <a name="6.2.2" />
...
#### 6.2.3 Type Checker Testing <a name="6.2.3" />
...
#### 6.2.4 Evaluator Testing <a name="6.2.4" />
...
#### 6.2.5 Error Handler Testing <a name="6.2.5" />
...
## Chapter 7 - Evaluation <a name="7" />


## Chapter 8 - Conclusions <a name="8" />
...
## Glossary of Terms <a name="terms" />
<dl>
  <dt>Abstraction</dt>
  ...
  <dt>Pipeline</dt>
  <dd>Information</dd>
  <dt>Real evaluate print loop (REPL)</dt>
